...
- feat: new plugin `dev-workflow-lite`
  ...
  - Dropped, as features outside the workflow itself: mid-run difficulty escalation, `implementation_executor`, `subagent_model`, `boundary_check_commands`, Workability Retrospective. Post-Commit Verification is folded into Interactive Commits as one rule.
