...
- The `Agent` tool for redrawing the page in the background. Without it the skill draws on the main thread, in the same turn as the answer, as it did before.
