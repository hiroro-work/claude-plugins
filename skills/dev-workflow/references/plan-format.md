...
- **Any user-facing prose output** — localization boundary (§ Localization granularity), and the summary preamble a structured-content gate emits (§ User-gate summary preamble)
