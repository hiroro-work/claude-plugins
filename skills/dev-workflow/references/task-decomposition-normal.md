...
Section B of [`task-decomposition.md`](task-decomposition.md), which keeps `## B. Normal sub-mode` as a pointer here. **Read that file first** — it holds the shared core this section depends on.
