...
### Choices I made
<Per item: the fork, which side was taken, why, and what the other side would have meant. When nothing qualifies, say so in one sentence rather than omitting the section.>
