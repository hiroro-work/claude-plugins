...
/dev-workflow --fast [--executor <value>] <task>        # Speed-first run mode (see `--fast` / `--deep` below)
/dev-workflow --deep [--executor <value>] <task>        # Thoroughness-first run mode (see `--fast` / `--deep` below)
